...
public class HelloWorldJavaFilterJavaTest {
    private HelloWorldJavaFilter filter;
    private HelloWorldJavaConfig config;
    ...
    public void setup() throws Exception {
        ...
        mockFilterConfig = new MockFilterConfig("HelloWorldJavaFilter");
        filter = new HelloWorldJavaFilter(mockConfigService);
        config = new HelloWorldJavaConfig();
    ...
    public void testFilterInitializedDefault() throws Exception {
        ...
        Mockito.verify(mockConfigService).subscribeTo(
                Matchers.eq("HelloWorldJavaFilter"),
                Matchers.eq("hello-world-java.cfg.xml"),
                argumentCaptor.capture(),
                Matchers.eq(filter),
                Matchers.eq(HelloWorldJavaConfig.class));

        assertTrue(argumentCaptor.getAllValues().toString().contains("/META-INF/schema/config/hello-world-java.xsd"));
    }
    ...
    public void testFilterInitializedGiven() throws Exception {
        ...
        Mockito.verify(mockConfigService).subscribeTo(
                ...
                Matchers.any(HelloWorldJavaFilter.class),
                Matchers.eq(HelloWorldJavaConfig.class));
    }
